...
public record KafkaProperties(Producer producer,
                              Consumer consumer,
                              Topics topics) {
    public record Producer(@JsonProperty(value = "bootstrap-servers") String bootstrapServers,
                           @JsonProperty(value = "key-serializer") String keySerializer,
